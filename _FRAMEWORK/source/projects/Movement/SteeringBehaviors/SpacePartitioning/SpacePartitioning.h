...
public:
	...
	void DebugRender(const SteeringAgent* pAgent, float neighborhoodRadius) const;
...
private:
	...
	Elite::Rect GetNeighborhoodRectangle(const Elite::Vector2 positionCenter, float rediusNeighborhood) const;
};
